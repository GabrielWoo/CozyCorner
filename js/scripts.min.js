...
$(function() {
	...
	var backgroundMusic = false; // Flag to check if background Music is on
	var backgroundMusicPaused = false; // Flag to check if backgorund Music is paused
	...
	var bgArtist1 = document.getElementById("artist1bgMusic"); 
	var $artist1 = $("#artist1");

	var bgArtist2 = document.getElementById("artist2bgMusic"); 
	var $artist2 = $("#artist2");

	var bgArtist3 = document.getElementById("artist3bgMusic"); 
	var $artist3 = $("#artist3");

	var bgRps = document.getElementById("rpsbgMusic");
	var $rpsWindow = $("#rpswindow");
	...
	var $game = $(".game");
	var $gameExplorer = $(".explorer-window.game-explorer");

	// Add games here
	var $rpsGame = $(".rpsgame");
	var $rpsGameExplorer = $(".explorer-window.rps-explorer");
	...
	// General functions to control the background Music
	function startBackroundMusic() {
		bgAudio.play();
		bgAudio.loop = true;
	...
	function computerPlay() {
		...
		complay = value;
		// Update the UI
		document.getElementById('com_' + value).querySelector('i').style.color = "green";

	}

	function clearRPSUI() {
		// Clear the UI
		document.getElementById('com_rock').querySelector('i').style.color = "white";
		document.getElementById('com_paper').querySelector('i').style.color = "white";
		document.getElementById('com_scissors').querySelector('i').style.color = "white";

		document.getElementById('rock').querySelector('i').style.color = "white";
		document.getElementById('paper').querySelector('i').style.color = "white";
		document.getElementById('scissors').querySelector('i').style.color = "white";
	}

	function updateScore(playerSelection) {

		let outcome = "";
		if (playerSelection === complay) {
			outcome = "Draw";
		} else if ((playerSelection == "rock") && (complay == "scissors")) {
			outcome = "Win";
		} else if ((playerSelection == "paper") && (complay == "rock")) {
			outcome = "Win";
		} else if ((playerSelection == "scissors") && (complay == "paper")) {
			outcome = "Win";
		} else if ((playerSelection == "paper") && (complay == "scissors")) {
			outcome = "Loss";
		} else if ((playerSelection == "scissors") && (complay == "rock")) {
			outcome = "Loss";
		} else if ((playerSelection == "rock") && (complay == "paper")) {
			outcome = "Loss";
		}
		...
		if (outcome == "Loss") {
			...
			outcome = '<span style="color: green;">Win</span>';
			rpsScore = rpsScore + 1;
		}
		else {
			outcome = '<span style="color: white;">Draw</span>';
		}
		document.getElementById('rps-results').innerHTML = outcome;
		document.getElementById('rps-score').innerHTML = rpsScore;
	...
	// Bind the clicks here
	$trash.on("click", function() {
		bindExplorer($trashExplorer);
	})

	$game.on("click", function () {
		bindExplorer($gameExplorer);
	})

	$rpsGame.on("click", function () {
		bindExplorer($rpsGameExplorer);
	})

	$rock.on("click", function () {
		clearRPSUI();
		document.getElementById('rock').querySelector('i').style.color = "green";
		// Computer play
		computerPlay();
		// Update Score
		updateScore("rock");
	...
	$paper.on("click", function () {
		clearRPSUI();
		document.getElementById('paper').querySelector('i').style.color = "green";
		// Computer play
		computerPlay();
		// Update Score
		updateScore("paper");
	...
	$scissors.on("click", function () {
		clearRPSUI();
		document.getElementById('scissors').querySelector('i').style.color = "green";
		// Computer play
		computerPlay();
		// Update Score
	...
	$artist1.on("mouseout", function () {
		bgArtist1.pause();

		// Pause Background Music
		if (backgroundMusicPaused && backgroundMusicPlaying) {
			startBackroundMusic();
		}
	})

	$artist2.on("mouseover", function () {
		bgArtist2.play();
		bgArtist2.loop = true;
	...
	$rpsWindow.on("mouseover", function () {
		bgRps.play();
		bgRps.loop = true;
	...
	$rpsWindow.on("mouseout", function () {
		bgRps.pause();
